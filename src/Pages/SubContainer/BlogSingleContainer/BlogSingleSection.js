          ...
          <div className="row">
            ...
            <div className="col-sm-9">
              ...
              <div className="socials-share">
                <a href="">
                  <img src="assets/images/blog/socials.png" alt="" />
                </a>
              </div>
              ...
              <div className="media commnets">
                <a className="pull-left" href="#">
                  <img
                    ...
                    src="assets/images/blog/man-one.jpg"
                    alt=""
                  />
                </a>
                ...
                <ul className="media-list">
                  <li className="media">
                    <a className="pull-left" href="#">
                      <img
                        className="media-object"
                        src="assets/images/blog/man-two.jpg"
                        alt=""
                      />
                    </a>
                    <div className="media-body">
                  ...
                  <li className="media second-media">
                    <a className="pull-left" href="#">
                      <img
                        className="media-object"
                        src="assets/images/blog/man-three.jpg"
                        alt=""
                      />
                    </a>
                    <div className="media-body">
                  ...
                  <li className="media">
                    <a className="pull-left" href="#">
                      <img
                        className="media-object"
                        src="assets/images/blog/man-four.jpg"
                        alt=""
                      />
                    </a>
                    <div className="media-body">
